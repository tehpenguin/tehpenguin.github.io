...
I set RHOST to the ip of my target, ran the exploit and we have room. Id and Uname -a confirms we are root in kioptrix.  

![Image description](/images/Kioptrix.1.1.5.png)
