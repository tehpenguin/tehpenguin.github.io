...
The attacker was able to open up an os shell through sql injection. His next step was to find netcat andattempt to conet to the target machine through netcat.
